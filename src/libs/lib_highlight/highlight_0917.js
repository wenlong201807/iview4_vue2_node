...
(function (factory) {
  ...
  */
  ...
  function createLineNumbersStyle() {
    ...
    // console.log(666999, lineNumbersStyle)
    styleEl.innerHTML = lineNumbersStyle.join("")
    // styleEl.innerHTML = lineNumbersStyle.join("").format("hljs");
    // console.log('style:', styleEl.innerHTML)
  ...
  function initLineNumbersOnLoad() {
    ...
    for (var i = 0; i < codeList.length; i++) {
      ...
      // codeHtml = "<ul class='highul'><li class='highli'>" + codeHtml.replace(/\n/g, "\n</li><li class='highli'>") + "\n</li></ul>";
      // console.log('codeHtml', codeHtml)
      // codeHtml = "<ul><li>" + codeHtml.replace(/\n/g, "\n</li><li>") + "\n</li></ul>";
      codeList[i].innerHTML = codeHtml;
    }
    // console.log('行号样式：', codeList)
  }
  ...
  */
  ...
  hljs.initLineNumbersOnLoad = initLineNumbersOnLoad; // 加入行号的样式
...
//       "padding: 5px!important;",
//       "margin: 0 !important;",
//       "line-heightimport { hljs } from '@/lib/js/highlight.js';
// : 14 px;
// ",
//       "word-break: break-all;",
//       "word-wrap: break-word;}"
